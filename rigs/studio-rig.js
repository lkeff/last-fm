...
const STUDIO_RIG = {
  ...
  instruments: {
    ...
    midi: [
      { manufacturer: 'Native Instruments', model: 'Komplete Kontrol S88', type: 'MIDI Controller' },
      { manufacturer: 'Arturia', model: 'KeyStep Pro', type: 'MIDI Controller' }
    ],
    sequencers: [
      { manufacturer: 'Akai', model: 'MPC X', type: 'Standalone Sequencer' },
      { manufacturer: 'Native Instruments', model: 'Maschine+', type: 'Standalone Sequencer' }
    ],
    moogModular: {
